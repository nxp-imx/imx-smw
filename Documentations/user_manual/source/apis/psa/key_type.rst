...
.. table:: Raw key encoding
   ...
   | CAT               | [13:12]  | =1                                           |
   +-------------------+----------+----------------------------------------------+
   | RAW-TYPE          | [11:8]   | See the :ref:`table_psa_raw_key_types` table |
   +-------------------+----------+                                              +
   | SUB-TYPE          | [7:1]    |                                              |
   +-------------------+----------+                                              +
   | P                 | [0]      |                                              |
...
.. table:: Symmetric key encoding
   ...
   +-------------------+----------+------------------------------------------------+
   | SYM-TYPE          | [7:1]    | See the :ref:`table_psa_sym_key_types` table.  |
   +-------------------+----------+                                                +
   | P                 | [0]      |                                                |
   +-------------------+----------+------------------------------------------------+
...
.. table:: Asymmetric key encoding
   ...
   +-------------------+----------+--------------------------------------------------+
   | ASYM-TYPE         | [11:7]   | See the :ref:`table_psa_asym_key_subtype` table. |
   +-------------------+----------+--------------------------------------------------+
