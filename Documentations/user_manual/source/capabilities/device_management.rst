...
.. table:: ELE Attestation Challenge
   :name: ele_challenge
   :widths: 15 12 10 18 40
   :width: 100%
   :align: center
   :class: wrap-table

   +------------+---------------+-------------+----------------------------+---------------------------------+
   | **Device** | **Challenge** | **Version** | **Certificate**            | **Comment**                     |
   +            +               +             +                            +                                 +
   |            | **in bytes**  |             |                            |                                 |
   +============+===============+=============+============================+=================================+
   | i.MX8ULP   |  4            | 0x1         | :ref:`table_device_att_v1` |                                 |
   +------------+---------------+-------------+----------------------------+---------------------------------+
   | i.MX91     |  16           | 0x2         | :ref:`table_device_att_v2` | OEM SRKH up to 512 bits         |
   +            +               +             +                            +                                 +
   | i.MX93     |               |             |                            |                                 |
   +------------+---------------+-------------+----------------------------+---------------------------------+
   | i.MX95     |  16           | 0x3         | :ref:`table_device_att_v3` | Hybrid OEM SRKH up to 512 bits  |
   +            +               +             +                            +                                 +
