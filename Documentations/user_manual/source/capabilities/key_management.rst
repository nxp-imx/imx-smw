...
.. table:: Key Management Operations vs. subsystem
   ...
   +------------------+-----------------------+---------+---------+----------+-----------------------------------------------------------------+
   | `Key Derivation`_| HKDF                  | **Y***  |    Y    |    N     | **ELE** HKDF is only supported on i.MX937, i.MX943 and i.MX952. |
   +------------------+-----------------------+---------+---------+----------+-----------------------------------------------------------------+
...
.. table:: SM2 vs. subsystem
   :name: table_sm2_subsystem
   :align: center
   :width: 100%
   :class: wrap-table
...
.. table:: Generate Key APIs Comparison
   ...
   +------------------+---------+----------------------------------------------+
   | SM2              | SMW     | :c:func:`smw_generate_key`                   |
   +                  +         +                                              +
   ...
   +------------------+---------+----------------------------------------------+
   | DERIVE           | SMW     | :c:func:`smw_generate_key`                   |
   +                  +         +                                              +
