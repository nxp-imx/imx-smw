...
.. table:: HMAC Support Details
   ...
   |               |                | SECO           | Y         | N             |
   +---------------+----------------+----------------+-----------+---------------+
   | SHA-256       | 32             | ELE            | Y         | Y (1)         |
   +               +                +----------------+-----------+---------------+
   |               |                | TEE            | Y         | Y             |
   +               +                +----------------+-----------+---------------+
   |               |                | SECO           | Y         | N             |
   +---------------+----------------+----------------+-----------+---------------+
   | SHA-384       | 48             | ELE            | Y         | Y (1)         |
   +               +                +----------------+-----------+---------------+
   |               |                | TEE            | Y         | Y             |
   +               +                +----------------+-----------+---------------+
   |               |                | SECO           | Y         | N             |
   +---------------+----------------+----------------+-----------+---------------+
   | SHA-512       | 64             | ELE            | N         | N (2)         |
   +               +                +----------------+-----------+---------------+
   |               |                | TEE            | Y         | Y             |
   +               +                +----------------+-----------+---------------+
   |               |                | SECO           | Y         | N             |
...
(1) ELA hardware acceleration supports HMAC SHA-256, HMAC SHA-384 and HMAC
    SHA-512 on all platforms except i.MX8ULP, i.MX91, i.MX93 and i.MX95 with
    plaintext key buffer only. ELA requires a non-empty input message.
(2) ELE subsystem does not support HMAC SHA-512. However, ELA does support HMAC
    SHA-512 with plaintext key buffer.
