...
static void device_lifecycle_merge_params(void *caps, void *params)
{
	(void)caps;
	(void)params;
...
static void device_lifecycle_print_params(void *params)
{
	(void)params;
}
...
DEFINE_CONFIG_OPERATION_FUNC(device_lifecycle);

static int device_reprovision_read_params(char **start, char *end,
					  void **params)
{
	(void)params;
...
static void device_reprovision_merge_params(void *caps, void *params)
{
	(void)caps;
	(void)params;
...
static void device_reprovision_print_params(void *params)
{
	(void)params;
}
...
DEFINE_CONFIG_OPERATION_FUNC(device_reprovision);
