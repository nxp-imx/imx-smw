...
static const struct {
	...
	PERMITTED_ALGO(HKDF_EXTRACT_SHA256, HKDF, NONE, SHA256, KEY_DERIVATION),
	PERMITTED_ALGO(HKDF_EXTRACT_SHA384, HKDF, NONE, SHA384, KEY_DERIVATION),
	PERMITTED_ALGO(HKDF_EXTRACT_SHA_ANY, HKDF, NONE, ANY, KEY_DERIVATION),
