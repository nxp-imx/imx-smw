...
const struct asn1_curve_def ec_asn1_curves[] = {
	...
	[EC_X25519] = EC_ASN1_CURVE(X25519),
	[EC_X448] = EC_ASN1_CURVE(X448),
	[EC_NB_KEY_NAME] = { 0 }
};
...
const struct dev_curve_def ec_smw_curves[] = {
	...
	[EC_X25519] = EC_SMW_CURVE(X25519, 255),
	[EC_X448] = EC_SMW_CURVE(X448, 448),
	[EC_NB_KEY_NAME] = { 0 }
};
...
const struct curve_def ec_curves[] = {
	...
	EC_CURVE(ED448, EC_EDWARDS),   EC_CURVE(X25519, EC_MONTGOMERY),
	EC_CURVE(X448, EC_MONTGOMERY), EC_CURVE(NB_KEY_NAME, UNKNOWN_KEY_TYPE),
};
