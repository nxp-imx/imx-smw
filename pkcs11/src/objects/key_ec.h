 ...
 *
 * If key attributes are correct, create a new EC Public key object.
 *
 * return:
...
/*
 * key_ec_public_retrieve() - Retrieve an EC public key object
 * @hsession: Session handle
 * @obj: EC Public Key object
 *
 * Retrieve an EC Public key object.
 *
 * return:
 * CKR_CRYPTOKI_NOT_INITIALIZED  - Context not initialized
 * CKR_SESSION_HANDLE_INVALID    - Session Handle invalid
 ...
 * CKR_OK                        - Success
 */
CK_RV key_ec_public_retrieve(CK_SESSION_HANDLE hsession,
 ...
 * @attrs: List of object attributes
 *
 * If key attributes are correct, create a new EC Private key object.
 *
 * return:
 * CKR_CRYPTOKI_NOT_INITIALIZED  - Context not initialized
 * CKR_SESSION_HANDLE_INVALID    - Session Handle invalid
...
/*
 * key_ec_private_retrieve() - Retrieve an EC private key object
 * @hsession: Session handle
 * @obj: EC Private Key object
 *
 * Retrieve an EC Private key object.
 *
 * return:
 * CKR_CRYPTOKI_NOT_INITIALIZED  - Context not initialized
 * CKR_SESSION_HANDLE_INVALID    - Session Handle invalid
 ...
 * CKR_OK                        - Success
 */
CK_RV key_ec_private_retrieve(CK_SESSION_HANDLE hsession,
			      struct libobj_obj *obj);
 ...
 *
 * If key attributes are correct, create and generate an EC Keypair object.
 *
 * return:
 * CKR_CRYPTOKI_NOT_INITIALIZED  - Context not initialized
 * CKR_SESSION_HANDLE_INVALID    - Session Handle invalid
...
/*
 * key_ec_keypair_retrieve() - Retrieve an EC keypair object
 * @hsession: Session handle
 * @pub_obj: EC Public Key object
 * @pub_obj: EC Private Key object
 *
 *
 * return:
 * CKR_CRYPTOKI_NOT_INITIALIZED  - Context not initialized
