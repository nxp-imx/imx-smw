...
struct test_def test_list[] = { TEST_DEF(get_info_ifs),
				...
				TEST_DEF(callback),
				TEST_DEF(digest),
				TEST_DEF(digest_multipart),
				TEST_DEF(sign_verify),
				TEST_DEF(sign_verify_message),
				TEST_DEF(sign_verify_multipart),
				TEST_DEF(sign_verify_multipart_message),
				TEST_DEF(random),
				TEST_DEF(encrypt_decrypt),
				TEST_DEF(encrypt_decrypt_aead),
				TEST_DEF(encrypt_decrypt_message),
				TEST_DEF(encrypt_decrypt_multipart),
				TEST_DEF(encrypt_decrypt_multipart_message),
				TEST_DEF(asymmetric_encryption),
				...
				TEST_DEF(performance),
				TEST_DEF(derive_key_tls1_3),
				TEST_DEF(derive_key_tls1_2) };
