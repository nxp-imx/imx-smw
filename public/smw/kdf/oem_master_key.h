 ...
 * @info_len: [in] Length in bytes of the information buffer.
 * @payload: [in/out] Depends on the operation type defined by the operation.
 * @payload_length: [in/out] Length in bytes of the payload buffer.
 *
 * OEM Master key derivation operation is not supported on all subsystems,
 * refer to the :ref:`subsystems-capabilities`.
 *
 ...
 * key. More details are available in the :ref:`subsystems-capabilities`.
 *
 ...
 * :ref:`SMW_KDF_NAME_OEM_MASTER_KEY <smw_kdf_t>`
 *
 ...
 *     Calling this operation with @payload set to NULL will return the expected
