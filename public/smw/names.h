 ...
 * * SMW_HASH_ALGO_NAME_SHAKE256: Secure Hash Algorithm KECCAK, 256 bits
...
typedef enum {
	...
	SMW_CIPHER_MODE_NAME_CFB, /* [AES] */
	SMW_CIPHER_MODE_NAME_CTR, /* [AES, SM4] */
	SMW_CIPHER_MODE_NAME_CTS,
	SMW_CIPHER_MODE_NAME_ECB, /* [AES, DES3, SM4, no_iv] */
	SMW_CIPHER_MODE_NAME_XTS, /* [AES, SM4] */
	SMW_CIPHER_MODE_NAME_OFB, /* [AES] */
 ...
 * * SMW_LIFECYCLE_NAME_CURRENT: Current
 * * SMW_LIFECYCLE_NAME_OEM_OPEN: OEM Open
 * * SMW_LIFECYCLE_NAME_OPEN: **Deprecated**, renamed as SMW_LIFECYCLE_NAME_OEM_OPEN
 * * SMW_LIFECYCLE_NAME_OEM_CLOSED: OEM Closed
 * * SMW_LIFECYCLE_NAME_CLOSED: **Deprecated**, renamed as SMW_LIFECYCLE_NAME_OEM_CLOSED
 * * SMW_LIFECYCLE_NAME_OEM_LOCKED: OEM Locked
 * * SMW_LIFECYCLE_NAME_CLOSED_LOCKED: **Deprecated**, renamed as SMW_LIFECYCLE_NAME_OEM_LOCKED
 * * SMW_LIFECYCLE_NAME_OEM_RETURN: OEM return
 * * SMW_LIFECYCLE_NAME_NXP_RETURN: NXP return
 * * SMW_LIFECYCLE_NAME_NB: Number of lifecycles
 */
typedef enum {
	SMW_LIFECYCLE_NAME_NONE,
	SMW_LIFECYCLE_NAME_CURRENT,
	SMW_LIFECYCLE_NAME_OEM_OPEN,
	SMW_LIFECYCLE_NAME_OPEN = SMW_LIFECYCLE_NAME_OEM_OPEN,
	SMW_LIFECYCLE_NAME_OEM_CLOSED,
	SMW_LIFECYCLE_NAME_CLOSED = SMW_LIFECYCLE_NAME_OEM_CLOSED,
	SMW_LIFECYCLE_NAME_OEM_LOCKED,
	SMW_LIFECYCLE_NAME_CLOSED_LOCKED = SMW_LIFECYCLE_NAME_OEM_LOCKED,
...
typedef enum {
	...
	SMW_ASYMMETRIC_ENCRYPTION_MODE_NAME_NO_PAD,    /* [RSA] */
