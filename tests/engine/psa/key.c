...
static const struct util_attr_info algo_info_psa[] = {
	...
	ATTR_ALGO_PSA(HKDF, PSA_ALG_HKDF(PSA_ALG_NONE)),
	ATTR_ALGO_PSA(ECDSA, PSA_ALG_ECDSA_BASE),
	ATTR_ALGO_PSA(ATTEST_ECDSA, PSA_ALG_VENDOR_ECDSA_ATTESTATION_BASE),
	ATTR_ALGO_PSA(ATTEST_CMAC, PSA_ALG_VENDOR_CMAC_ATTESTATION),
