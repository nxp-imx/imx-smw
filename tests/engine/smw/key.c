...
static struct {
	...
	KEY_TYPE(DES3),	      KEY_TYPE(SM2),	      KEY_TYPE(SM4),
...
static const struct util_attr_info algo_info[] = {
	ATTR_ALGO(ECB_NO_PADDING, SYMMETRIC_ENCRYPTION, AES, ECB_NO_PAD, NONE),
	ATTR_ALGO(ECB_NO_PADDING, SYMMETRIC_ENCRYPTION, DES, ECB_NO_PAD, NONE),
	ATTR_ALGO(ECB_NO_PADDING, SYMMETRIC_ENCRYPTION, DES3, ECB_NO_PAD, NONE),
	ATTR_ALGO(ECB_NO_PADDING, SYMMETRIC_ENCRYPTION, SM4, ECB_NO_PAD, NONE),
	ATTR_ALGO(CBC_NO_PADDING, SYMMETRIC_ENCRYPTION, AES, CBC_NO_PAD, NONE),
	ATTR_ALGO(CBC_NO_PADDING, SYMMETRIC_ENCRYPTION, DES, CBC_NO_PAD, NONE),
	ATTR_ALGO(CBC_NO_PADDING, SYMMETRIC_ENCRYPTION, DES3, CBC_NO_PAD, NONE),
	ATTR_ALGO(CBC_NO_PADDING, SYMMETRIC_ENCRYPTION, SM4, CBC_NO_PAD, NONE),
	ATTR_ALGO(CFB, SYMMETRIC_ENCRYPTION, AES, CFB, NONE),
	ATTR_ALGO(CFB, SYMMETRIC_ENCRYPTION, DES, CFB, NONE),
	ATTR_ALGO(CFB, SYMMETRIC_ENCRYPTION, DES3, CFB, NONE),
	ATTR_ALGO(CFB, SYMMETRIC_ENCRYPTION, SM4, CFB, NONE),
	ATTR_ALGO(CTR, SYMMETRIC_ENCRYPTION, AES, CTR, NONE),
	ATTR_ALGO(CTR, SYMMETRIC_ENCRYPTION, DES, CTR, NONE),
	ATTR_ALGO(CTR, SYMMETRIC_ENCRYPTION, DES3, CTR, NONE),
	ATTR_ALGO(CTR, SYMMETRIC_ENCRYPTION, SM4, CTR, NONE),
	ATTR_ALGO(OFB, SYMMETRIC_ENCRYPTION, AES, OFB, NONE),
	ATTR_ALGO(OFB, SYMMETRIC_ENCRYPTION, DES, OFB, NONE),
	ATTR_ALGO(OFB, SYMMETRIC_ENCRYPTION, DES3, OFB, NONE),
	ATTR_ALGO(OFB, SYMMETRIC_ENCRYPTION, SM4, OFB, NONE),
	ATTR_ALGO(XTS, SYMMETRIC_ENCRYPTION, AES, XTS, NONE),
	ATTR_ALGO(XTS, SYMMETRIC_ENCRYPTION, DES, XTS, NONE),
	ATTR_ALGO(XTS, SYMMETRIC_ENCRYPTION, DES3, XTS, NONE),
	ATTR_ALGO(XTS, SYMMETRIC_ENCRYPTION, SM4, XTS, NONE),
	ATTR_ALGO(ALL_CIPHER, SYMMETRIC_ENCRYPTION, AES, ANY, NONE),
	ATTR_ALGO(CCM, AEAD, AES, CCM, NONE),
	ATTR_ALGO(GCM, AEAD, AES, GCM, NONE),
	ATTR_ALGO(ALL_AEAD, AEAD, AES, ANY, NONE),
	ATTR_ALGO(CHACHA20_POLY1305, AEAD, CHACHA20, POLY1305, NONE),
	ATTR_ALGO(CMAC, MAC, AES, CMAC, NONE),
	ATTR_ALGO(HMAC, MAC, HMAC, NONE, ANY),
	ATTR_ALGO_CURVE(ECDSA, ASYMMETRIC_SIGNATURE, ECDSA, ANY, ANY),
	ATTR_ALGO_EDDSA(EDDSA, ASYMMETRIC_SIGNATURE, EDDSA, ANY, ANY, NONE),
	ATTR_ALGO_EDDSA(PURE_EDDSA, ASYMMETRIC_SIGNATURE, EDDSA, ANY, NONE,
			NONE),
	ATTR_ALGO_EDDSA(ED25519PH, ASYMMETRIC_SIGNATURE, EDDSA, ED25519, NONE,
			PREHASHED),
	ATTR_ALGO_EDDSA(ED25519CTX, ASYMMETRIC_SIGNATURE, EDDSA, ED25519, NONE,
			CONTEXT),
	ATTR_ALGO_EDDSA(ED448PH, ASYMMETRIC_SIGNATURE, EDDSA, ED448, NONE,
			PREHASHED),
	...
	ATTR_ALGO(TLS_1_3, KEY_DERIVATION, TLS_1_3, ANY, ANY),
	ATTR_ALGO(ATTEST_CMAC, KEY_ATTESTATION, AES, CMAC, NONE),
	...
	ATTR_ALGO(RSA_PKCS1_V15, ASYMMETRIC_ENCRYPTION, RSA, PKCS1_1_5, NONE),
	ATTR_ALGO(RSA_OAEP, ASYMMETRIC_ENCRYPTION, RSA, OAEP, ANY),
	ATTR_ALGO(RSA_NO_PAD, ASYMMETRIC_ENCRYPTION, RSA, NO_PAD, NONE),
	...
	ATTR_ALGO_CURVE(SM2, ASYMMETRIC_SIGNATURE, SM2, SM2, SM3),
	{ .string = NULL }
};
...
void algorithm_callback(void *user_data, const char *params[], size_t n_params)
{
	...
	*algo = ATTR_ARRAY_FIND_MATCH(algo_info, params[0]).smw_algo;
	...
	for (; i < n_params; i++) {
		...
		if (!strcmp(param, MSG_HASHED_STR))
			*algo = SMW_ATTR_SET_MSG_HASHED(*algo);
	}

	DBG_PRINT("SMW algorithm: %#" PRIx64, *algo);
}
