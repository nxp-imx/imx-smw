...
/**
 * sign_verify_init() - Do a sign or verify initialization operation.
 * @subtest: Subtest data.
 * @operation: SIGN_OPERATION or VERIFY_OPERATION
 *
 * Return:
...
/**
 * sign_verify_update() - Do a sign or verify update operation.
 * @subtest: Subtest data.
 * @operation: SIGN_OPERATION or VERIFY_OPERATION
 *
 * Return:
...
/**
 * sign_verify_final() - Do a sign or verify final operation.
 * @subtest: Subtest data.
 * @operation: SIGN_OPERATION or VERIFY_OPERATION
 *
 * Return:
